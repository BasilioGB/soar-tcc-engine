    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("role", models.CharField(choices=[("ADMIN", "Admin"), ("SOC_LEAD", "Soc Lead"), ("SOC_ANALYST", "Soc Analyst")], default="SOC_ANALYST", max_length=32)),
                ("display_name", models.CharField(blank=True, max_length=128)),
                ("timezone", models.CharField(default="UTC", help_text="IANA timezone name", max_length=64)),
